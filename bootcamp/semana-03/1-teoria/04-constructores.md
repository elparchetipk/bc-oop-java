...
Un **constructor** es un método especial que se ejecuta automáticamente cuando se crea un objeto de una clase. Su
propósito principal es **inicializar** los atributos del objeto.

### Definición

> Un constructor es un bloque de código especial que prepara un objeto recién creado para su uso, estableciendo valores
> iniciales en sus atributos.
...
println(p.getNombre()); // "Sin nombre"
```
